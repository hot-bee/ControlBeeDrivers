...
//-------------------------------------------------------------------------------------------------------------------
    ...
    [DllImport("AXL.dll")] public static extern uint AxmMoveGetStartMultiPosParam(ref int npArraySize, ref double lpAxesNoArrGet, ref double dpPosArrGet, ref double dpVelArrGet, ref double dpAccelArrGet, ref double dpDecelArrGet);
	// lsg 231114
    ...
    [DllImport("AXL.dll")] public static extern unsafe uint AxmMoveGetLastParam(int nAxisNo, ref double dpPos, double* dpVel, ref double dpAccel, ref double dpDecel);
}
