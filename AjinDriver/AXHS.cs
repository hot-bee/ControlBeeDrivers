...
public struct AXT_MOVE_START_POS_PARAM
{
	long lAxisNo;
	double dPos;
	double dVel;
...
public struct AXT_MOVE_POS_PARAM
{
	long lAxisNo;
	double dPos;
	double dVel;
...
public struct AXT_MOVE_VEL_PARAM
{
	long lAxisNo;
	double dVel;
	double dAccel;
...
public struct AXT_MOVE_START_MULTI_POS_PARAM
{
	long lArraySize;
    unsafe long* lMultiAxesNo;
    unsafe double* dMultiPos;
	unsafe double* dMultiVel;
	unsafe double* dMultiAccel;
	unsafe double* dMultiDecel;
};

// lsg 231114
public struct AXT_MOVE_TO_ABS_POS_PARAM
{
	long lAxisNo;
	double dPos;
	double dVel;
